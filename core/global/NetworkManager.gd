...
enum NetworkFlags {
	NONE				= 0, ## No flags
	ALLOW_SERIALIZE		= 1 << 1, ## Allows EngineComponents to be serialized on an outgoing message
	ALLOW_DESERIALIZE	= 1 << 2, ## Allows EngineComponents to be deserialized on an incomming message
}
